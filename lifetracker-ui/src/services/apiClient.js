...
class ApiClient {
    ...
    async fetchUserNutritions() {
        return await this.request({ endpoint: `nutrition/`, method: `POST`})   
    }
    ...
    async fetchUserExercises() {
        return await this.request({ endpoint: `exercise/`, method: `POST`})   
    }
    ...
    async fetchUserSleeps() {
        return await this.request({ endpoint: `sleep/`, method: `POST`})   
    }
...
export default new ApiClient("https://lifetracker-am.herokuapp.com")